...
# Bot TokenTOKEN = os.getenv("TELEGRAM_TOKEN", "8482767906:AAG5MlJz95FEwtaCCugJXuC-Tbg07ICSUak")
...
def analyze_sales(file_path):
    ...
    if file_path.endswith('.json'):
        ...
        top_items.sort(key=lambda x: x['revenue'], reverse=True)        return {
                    ...
                    try:
                        ...
                        if audit_sections:
                            ...
                            audit_prompt = (
                                ...
                                "with responsável. Se não houver desvios relevantes, informe brevemente."
                            )
